<script setup lang="ts">
  ...
  onMounted(() => {
    ...
    // Animation for data packets in the visualization
    ...
    timeline
      .to("#data-packet-1", { x: 100, y: 75 })
      .to("#data-packet-2", { x: -100, y: 75 }, 0.3)
      .to("#data-packet-3", { x: 100, y: -75 }, 0.6)
      .to("#data-packet-4", { x: -100, y: -75 }, 0.9)
      .to("#data-packet-1", { x: 0, y: 0 }, 1.5)
      .to("#data-packet-2", { x: 0, y: 0 }, 1.8)
      .to("#data-packet-3", { x: 0, y: 0 }, 2.1)
      .to("#data-packet-4", { x: 0, y: 0 }, 2.4);

    // Subtle pulsing animation for node groups
    gsap.to(
      ["#node-group-1", "#node-group-2", "#node-group-3", "#node-group-4"],
      {
        scale: 1.05,
        repeat: -1,
        yoyo: true,
    ...
    // Animate the central node with a glow effect
    gsap.to('circle[cx="250"][cy="175"][r="20"]', {
      opacity: 0.2,
      scale: 1.2,
      repeat: -1,
      duration: 2,
...
<template>
  <div class="container pb-20 pt-44 text-center">
      ...
      >
        <svg viewBox="0 0 631 236" class="h-8" fill="none">
          ...
          <path
            ...
            stroke="currentColor"
            stroke-width="14.1634"
            stroke-linecap="round"
          />
        </svg>

        <svg class="h-6 fill-current" viewBox="0 0 284 65">
          <path
        ...
        >
          <g fill="currentColor">
            <path
              d="m199.202 85.75h8.638v-31.662h-8.638zm-.367-39.847c0-2.813 1.567-4.219 4.701-4.219 3.133 0 4.701 1.406 4.701 4.219 0 1.341-.392 2.384-1.175 3.13-.784.746-1.959 1.118-3.526 1.118-3.134 0-4.701-1.416-4.701-4.248z"
            />
            <path
              clipRule="evenodd"
    ...
    >
      ...
      <section
        id="about"
        class="relative py-20 overflow-hidden bg-crypto-dark-800"
      >
        <!-- Background elements -->
        <div class="absolute inset-0 z-0">
          <div
            class="absolute bottom-0 right-0 w-full h-full opacity-10 bg-grid-pattern"
          ></div>
          <div
            class="absolute top-40 -left-20 w-96 h-96 rounded-full bg-crypto-teal-500/10 blur-3xl"
          ></div>
          <div
            class="absolute -bottom-20 right-0 w-full h-1/2 bg-gradient-to-t from-crypto-dark-900 to-transparent opacity-70"
          ></div>
        </div>

        <div class="container mx-auto px-4 relative z-10">
          <div class="grid md:grid-cols-2 gap-12 items-center">
            <!-- Left column with image and animations -->
            <div ref="aboutVisual" class="relative">
              <!-- Tech Visualization -->
              <div class="max-w-lg mx-auto">
                <div
                  class="relative p-6 rounded-2xl bg-crypto-dark-700/70 backdrop-blur-sm border border-crypto-dark-500/50"
                >
                  <!-- Blockchain visualization SVG -->
                  <svg
                    width="100%"
                    height="350"
                    viewBox="0 0 500 350"
                  ...
                  >
                    <defs>
                      ...
                      >
                        ...
                        <stop offset="100%" stop-color="#2CA9FF" />
                      </linearGradient>
                      <linearGradient
                        id="about-gradient-2"
                        x1="0%"
                        ...
                        y2="100%"
                      >
                        <stop offset="0%" stop-color="#2CA9FF" />
                    ...
                    <!-- Data packages moving through the network -->
                    <circle
                      id="data-packet-1"
                      cx="150"
                      cy="100"
                  ...
                  <!-- Floating elements -->
                  <div
                    class="absolute top-10 left-10 w-8 h-8 bg-crypto-teal-500/20 rounded-md animate-float"
                  ></div>
                  <div
                    class="absolute bottom-10 right-10 w-10 h-10 bg-crypto-purple-500/20 rounded-full animate-float"
                    style="animation-delay: 1.5s"
                  ></div>
                  <div
                    class="absolute top-1/2 right-4 w-6 h-6 bg-crypto-blue-500/20 rounded-md animate-float"
            ...
            <div ref="aboutContent" class="space-y-8">
              <div>
                <div
                  class="inline-block px-4 py-1 rounded-full bg-crypto-purple-500/20 text-crypto-purple-400 text-sm font-semibold mb-4"
                >
                  Enterprise Solutions
                </div>
                <h2
                  class="text-3xl md:text-4xl font-bold ai-gradient-text crypto-gradient-text mb-6"
                >
                  High-Performance AI Infrastructure
                </h2>
                <p class="text-crypto-light-400 text-lg">
                  AI Runner provides a reliable, scalable infrastructure layer
                  for AI-powered applications. Our platform addresses the major
                  challenges in AI deployment today: cost, reliability, and
                  expertise, with a simple and robust API-first approach.
                </p>
              </div>

              <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-8">
                <div class="ai-card crypto-card bg-crypto-dark-700/60">
                  <div class="flex items-center space-x-4">
                    <div
                      class="h-10 w-10 rounded-full bg-crypto-teal-500/20 flex items-center justify-center"
                    >
                      <svg
                        class="h-5 w-5 text-crypto-teal-400"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    ...
                    <div>
                      ...
                      <p class="text-sm text-crypto-light-500">
                        SOC2 and HIPAA compliant with end-to-end encryption
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="ai-card crypto-card bg-crypto-dark-700/60">
                  <div class="flex items-center space-x-4">
                    <div
                      class="h-10 w-10 rounded-full bg-crypto-blue-500/20 flex items-center justify-center"
                    >
                      <svg
                        class="h-5 w-5 text-crypto-blue-400"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    ...
                    <div>
                      ...
                      <p class="text-sm text-crypto-light-500">
                        Sub-10ms inference latency with GPU acceleration
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="ai-card crypto-card bg-crypto-dark-700/60">
                  <div class="flex items-center space-x-4">
                    <div
                      class="h-10 w-10 rounded-full bg-crypto-purple-500/20 flex items-center justify-center"
                    >
                      <svg
                        class="h-5 w-5 text-crypto-purple-400"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                    ...
                    <div>
                      <h3 class="font-semibold">Usage-Based Pricing</h3>
                      <p class="text-sm text-crypto-light-500">
                        Pay only for what you use with transparent billing
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="ai-card crypto-card bg-crypto-dark-700/60">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-crypto-light-500">
                        Deployed across 30+ regions for minimal latency
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <p class="text-crypto-light-400 mb-6">
                  Founded in 2023 by a team of AI infrastructure experts from
                  leading tech companies, AI Runner has quickly grown to power
                  thousands of enterprise applications with reliable,
                  high-performance AI services.
                </p>
                <button class="ai-button-primary crypto-button-primary">
